			...
			<form action method="get">
				...
				<fieldset>
					<legend>Vas-tu boire de l'acool à cette soirée ? </legend>
						...
						<input id="question1" type="radio" name="combi1" value="true" checked <?php if( $combi1=='true'){ echo 'checked="checked"';} ?> required>
						<label for="question12">Non</label>
						<input id="question12" type="radio" name="combi1" value="false" <?php if( $combi1=='false'){ echo 'checked="checked"';} ?> required>
				</fieldset>

				<fieldset>
					<legend>Connais-tu Bob ?</legend>
						<label for="question2">Oui</label>
						<input id="question2"type="radio" name="combi2" value="true" checked <?php if( $combi2=='true'){ echo 'checked="checked"';} ?> required>
						<label for="question22">Non</label>
						<input id="question22" type="radio" name="combi2" value="false" <?php if( $combi2=='false'){ echo 'checked="checked"';} ?> required>
				</fieldset>
					
				<fieldset>	
					<legend>Est ce qu'il neige ?</legend>
						<label for="question3">Oui</label>
						<input id="question3" type="radio" name="combi3" value="true" checked <?php if( $combi3=='true'){ echo 'checked="checked"';} ?> required>
						<label for="question32">Non</label>
						<input id="question32" type="radio" name="combi3" value="false" <?php if( $combi3=='false'){ echo 'checked="checked"';} ?> required>
				</fieldset>

				<fieldset>
					<legend>As tu de l'argent pour mettre de l'essence? </legend>
						<label for="question4">Oui</label>
						<input id="question4" type="radio" name="combi4" value="true" checked <?php if( $combi4=='true'){ echo 'checked="checked"';} ?> required>
						<label for="question42">Non</label>
						<input id="question42" type="radio" name="combi4" value="false" <?php if( $combi4=='false'){ echo 'checked="checked"';} ?> required>
				</fieldset>

				<fieldset>
					<legend>Comptes tu encore aller jusque maastricht?</legend>
						<label for="question5">Oui</label>
						<input id="question5" type="radio" name="combi5" value="true" checked <?php if( $combi5=='true'){ echo 'checked="checked"';} ?> required>
						<label for="question52">Non</label>
						<input id="question52" type="radio" name="combi5" value="false" <?php if( $combi5=='false'){ echo 'checked="checked"';} ?> required>
				</fieldset>
				<fieldset>
					<legend>Vas-tu ramener tes copains qui boivent toujours trop ?</legend>
						<label for="question6">Oui</label>
						<input id="question6" type="radio" name="combi6" value="true" checked <?php if( $combi6=='true'){ echo 'checked="checked"';} ?> required>
						<label for="question61">Non</label>
						<input id="question61" type="radio" name="combi6" value="false" <?php if( $combi6=='false'){ echo 'checked="checked"';} ?>required>
				</fieldset>
